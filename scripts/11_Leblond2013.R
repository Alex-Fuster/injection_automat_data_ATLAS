...
file_name <- "retrieved_datasets/11_Table_Data.xlsx"
...
write.csv(metadata, file = "output_tables/11_Leblond2013_metadata.csv", row.names = FALSE)
...
write.csv(taxa_obs, file = "output_tables/11_Leblond2013_taxa_obs.csv", row.names = FALSE)
...
write.csv(time_series, file = "output_tables/11_Leblond2013_time_series.csv", row.names = FALSE)
