###########################################################################
# Injection of Sanspiper time-series into Atlas
...
data_timeseries <- brut |>
  ...
  dplyr::select(c("Year", "Sandpiper_nestdensity")) 
...
# Add a new row
taxa_obs <- taxa_obs |>
  dplyr::add_row(scientific_name = "Calidris bairdii", rank = "species") |>
...
time_series <- time_series |>
  ...
  dplyr::rename(values = "Sandpiper_nestdensity") |>
  dplyr::summarise(
